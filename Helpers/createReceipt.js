 ...
 * @description Convert base64 image to file and save it
 * @param {string} str - Base64 string or regular string
 * @param {string} accountID - Account ID for directory structure
 * @returns {string} - File path
 */
const createReceipt = async (str, accountID) => {
